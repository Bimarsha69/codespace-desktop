...
```
curl -O https://github.com/playstation452/codespace-desktop/blob/main/install.sh
chmod +x install.sh
./install.sh
```
for dev branch (unstable)
```
curl -O https://github.com/playstation452/codespace-desktop/blob/main/install-dev.sh
